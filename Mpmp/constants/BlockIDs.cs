...
namespace Mpmp.constants
{
    class BlockIDs
    {
        ...
        public   const int PLANK = 5;
        public   const int PLANKS = 5;
        public   const int WOODEN_PLANK = 5;
        public   const int WOODEN_PLANKS = 5;
        public   const int SAPLING = 6;
        public   const int SAPLINGS = 6;
        ...
        public   const int TRUNK = 17;
        public   const int LEAVES = 18;
        public   const int LEAVE = 18;
        ...
        public   const int WHEAT_BLOCK = 59;
        ...
        public   const int DOOR_BLOCK = 64;
        public   const int WOODEN_DOOR_BLOCK = 64;
        public   const int WOOD_DOOR_BLOCK = 64;
        public   const int LADDER = 65;

        public   const int COBBLE_STAIRS = 67;
        ...
        public   const int SUGARCANE_BLOCK = 83;
        ...
        public   const int STONE_BRICKS = 98;
        public   const int STONE_BRICK = 98;

        public   const int GLASS_PANE = 102;
        public   const int GLASS_PANEL = 102;
        ...
        public   const int NETHER_BRICKS = 112;
        public   const int NETHER_BRICK_BLOCK = 112;

        public   const int NETHER_BRICKS_STAIRS = 114;
        ...
        public   const int NETHER_REACTOR = 247;
    }
}
